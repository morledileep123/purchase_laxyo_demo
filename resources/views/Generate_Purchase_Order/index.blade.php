          ...
          <div class="col-12">
            ...
            <ul class="nav nav-tabs" id="myTab" role="tablist">
              <li class="nav-item" style="width: 33%">
                <a class="nav-link text-center active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true"><b>Generate Purchase Order</b></a>
              </li>
              <li class="nav-item" style="width: 34%">
                <a class="nav-link text-center" id="approve-tab" data-toggle="tab" href="#approve" role="tab" aria-controls="approve" aria-selected="false"><b>Approve Purchase Order</b></a>
              </li>
              <li class="nav-item" style="width: 33%">
                <a class="nav-link text-center" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false"><b>Send Purchase Order</b></a>
              </li>
            </ul>
            <div class="tab-content" id="myTabContent">
                  ...
                  <td>
                    <div class="btn-group">
                      ...
                      <div class="dropdown-menu">                           
                        <a class="dropdown-item" href="{{route('generate_po.show',$row->id )}}"><i class="fa fa-eye" aria-hidden="true"></i> View Purchase Order</a>
                        <a class="dropdown-item" href="{{url('pdf_download',$row->id )}}"><i class="fa fa-file-pdf" aria-hidden="true"></i>  Download</a>
                        <a class="dropdown-item" href="{{route('generate_po.edit',$row->id )}}"><i class="fa fa-edit" aria-hidden="true"></i> Edit Purchase Order</a>
              ...
              <div class="tab-pane fade show" id="approve" role="tabpanel" aria-labelledby="approve-tab">
                <div class="table-responsive">
                <table class="table table-bordered table-hover" id="inv-table">
                <thead>  
                  {{-- arsenal --}}
                ...
                @foreach($approve_po as $row)
                  ...
                  <tr>
                    ...
                    <td><h6 class="text-success">Approve</h6></td>
                    <td>
                      <div class="btn-group">
                        <button type="button" class="btn btn-secondary dropdown-toggle dropdown-icon" data-toggle="dropdown">Action
                        </button>
                        <div class="dropdown-menu">                           
                          <a class="dropdown-item" href="{{url('send_purchase_order',$row->id )}}"><i class="fa fa-eye" aria-hidden="true"></i> View Purchase Order</a>
                          <a class="dropdown-item" href="{{url('pdf_download',$row->id )}}"><i class="fa fa-file-pdf" aria-hidden="true"></i>  Download</a>                            
                        </div>
                      </div>
                    </td>
