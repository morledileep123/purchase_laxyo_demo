                    ...
                    <td>
                      <div class="btn-group">
                        ...
                        <div class="dropdown-menu">                           
                          <a class="dropdown-item" href="{{url('admin_grr_view',$row->id )}}"><i class="fa fa-eye" aria-hidden="true"></i> View GRR</a>
                          <a class="dropdown-item" href="{{url('invoicedownloadadmin',$row->id )}}"><i class="fa fa-file-pdf" aria-hidden="true"></i> Download</a>
                        </div>
                      </div>
                    </td>
