    ...
    <div class="col-md-12">
        ...
        <div class="col-md-6">
          <!-- general form elements -->
            <div class="card">
              <div class="card-header bg-light">
                <h3 class="card-title">Invoice Notice / Comment</h3>
              </div>
              <div class="card-body">
