                ...
                <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                  ...
                  @foreach($invoices as $row)
                    <tr>
                      ...
                      <td>{!! nl2br(e($row->admin_comment)) !!}</td>
                      ...
                      <td>
                        <div class="btn-group">
                          ...
                          <div class="dropdown-menu">                           
                            <a class="dropdown-item" href="{{url('superadmin_grr_view',$row->id )}}"><i class="fa fa-eye" aria-hidden="true"></i> View GRR</a>
                            <a class="dropdown-item" href="{{url('invoicedownloadsuperadmin',$row->id )}}"><i class="fa fa-file-pdf" aria-hidden="true"></i> Download</a>
                          </div>
                        </div>
                      </td>
                  ...
                  @foreach($invoices_send as $row)
                    <tr>
                      ...
                      @elseif($row->acountent_status == 1 && $row->superadmin_approve == 1 && $row->superadmin_status == 1 && $row->admin_approve == 1 && $row->admin_status == 1 && $row->manager_aprove == 1 && $row->manager_status == 1 && $row->user_send_grr == 1)
                        <td class="text-primary">{{'Send to Accountant'}}</td>
