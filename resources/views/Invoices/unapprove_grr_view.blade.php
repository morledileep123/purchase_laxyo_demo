  ...
  <div class="wrapper">
    ...
    <nav class="navbar navbar-light bg-light justify-content-between" style="background-color: #fff;">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            @if($data->decline_status == '0')
            <button class="btn btn-primary HoldReason" value="{{$data->hold_reason}}">Hold</button> 
            @else 
            <button class="btn btn-danger DeleteReason" value="{{$data->decline_reason}}">Decline</button>    
            @endif
...
<div class="modal fade" id="HoldReasonModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
       <textarea name="hold" class="form-control" id="hold" rows="7%" cols="48%" readonly></textarea>
      </div>
    </div>
  </div>
</div>
