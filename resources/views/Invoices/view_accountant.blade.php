    ...
    <div class="wrapper">
      ...
      <nav class="navbar navbar-light bg-light justify-content-between" style="background-color: #fff;">
        <div class="container">
          ...
          <a href="{{url('payment/create',$data->id)}}" type="button" class="btn btn-success btn-sm" style="color:white">Approval for amount</a>
          @else
          @endif 

          <a href="/">
            <img src="{{asset('assets/img/laxyo_pic.png')}}" class="thumbnail img-responsive" alt="Laxyo Energy LTD" style="max-width: 50%;">
          </a>
        ...
        <div class="form-inline">
          ...
          <a href="{{ url()->previous() }}" class="btn btn-secondary ml-2 btn-sm">Back</a>
          </div>
        </div>
        </div>
      </nav>
