      ...
      <nav class="navbar navbar-light bg-light justify-content-between" style="background-color: #fff;">
        <div class="container">
          <div class="row">
            <div class="col-md-6">
               <a href="/">
                <img src="{{asset('assets/img/laxyo_logoo.png')}}" class="thumbnail img-responsive" alt="Laxyo Energy LTD" style="max-width: 37%;">
              </a>
            </div>
            <div class="col-md-6">
              <div class="form-inline mt-1" style="float:right;">
                <div class="btn-group">
                  ...
                  <div class="dropdown-menu">  
                    ...
                    <a class="dropdown-item" href="{{url('invoicedownloaduser',$data->id )}}"><i class="fa fa-file-pdf" aria-hidden="true"></i>PDF Download</a>                       
                  </div>
                  ...
                  <div class="container-fluid ml-5">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-5">
                        ...
                        <p>{!! nl2br(e($data->delivery_location)) !!}</p>
                      </div>
                    </div>
                    <br>
                  </div>
