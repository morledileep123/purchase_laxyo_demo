  ...
  <body>
    ...
    <div class="wrapper">
      ...
      <nav class="navbar navbar-light bg-light justify-content-between" style="background-color: #fff;">
        <div class="container">
          <button type="button" class="btn btn-success" data-toggle="modal" data-target="#SendGRRtoAdminModal" style="color:white">Send to Accounatnt</button>
        ...
        <div class="form-inline">
          <div class="btn-group">
            ...
            <div class="dropdown-menu">  
              ...
              <a class="dropdown-item" href="{{url('invoicedownloadsuperadmin',$data->id )}}"><i class="fa fa-file-pdf" aria-hidden="true"></i>PDF Download</a>                       
            </div>
...
<div class="modal fade" id="SendGRRtoAdminModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="{{url('sendaccount')}}" method="POST" enctype="multipart/form-data">
      @csrf
        <div class="modal-body">
          <input type="hidden" name="team_id" value="{{$data->team_id}}">
          <input type="hidden" name="id" value="{{$data->id}}">
          <textarea class="form-control" name="superadmin_comment" rows="4%"></textarea>           
        </div>
        <div class="modal-footer">
