...
<div class="container-fluid">
    ...
    <h5 class="main-title-w3layouts mb-2">Create RFQ</h5>
                 ...
                 <div class="row">
                  <div class="col-md-8">
                    <label>For Site</label>
                      ...
                      @foreach($sites as $stee)
                      <option value="{{$stee->name}}">{{$stee->name}}</option>
                      @endforeach
                      </select>
                  </div>
                  <div class="col-md-4">
...
$(document).ready(function(){
  ...
  $(document).on('click', '#add_row', function(){
    ...
    html_code += '<td colspan="3"><div class="row"> <div class="col-md-4"><input type="number" name="quantity[]" id="quantity'+count+'" data-srno="1" class="form-control input-sm unit" required/></div> <div class="col-md-4"><select name="quantity_unit[]" class="form-control input-sm quantity_unit"><option>Select unit<?php echo fill_unit_select_box($connect ?? ''); ?></option></select></div>   <div class="col-md-4"><textarea name="description[]" id="description'+count+'" data-srno="'+count+'" class="form-control input-sm number_only description"></textarea></div>   </td>';
