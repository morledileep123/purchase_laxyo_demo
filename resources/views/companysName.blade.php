...
<div class="container-fluid">
  ...
  <h5 class="main-title-w3layouts mb-2">Departmental list</h5>
            ...
            @if (!empty($department))
              ...
              <tr>
                ...
                <td>
                  ...
                  <form id="delete-form-{{ $row->id }}" action="{{ route('department.destroy', $row->id) }}" method="POST" style="display: none;">
                    @csrf
                    @method('DELETE')
      ...
      <div class="modal-body">
          ...
          <div class="row">
            ...
            <div class="form-group col-md-12">
              ...
              <textarea class="form-control" rows="3" id="description" name="description" placeholder="department Description"></textarea>
            </div>
          </div>
