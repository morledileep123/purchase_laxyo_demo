...
<div class="container-fluid">
    <div class="card shadow mt-3">
        ...
        <table id="examplee" class="table table-bordered display table-hover" style="width:100%">
          <thead>
            ...
            <tbody id="tbl-tbody">
              @foreach($data as $row)
                <tr class="text-center">
                  ...
                  <td>
                    <a href="{{route('check_manager_rfq',$row->id)}}" class="btn btn-primary btn-sm"><i class="fa fa-eye"></i> View</a>
                  </td>
                </tr>
              @endforeach
            </tbody>
