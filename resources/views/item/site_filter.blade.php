    ...
    <table id="example" class="display" style="width:100%">
        ...
        <ul>
          ...
          <form action="{{ route('item.destroy',$row->id) }}" method="POST">
                ...
                <td>{{ $row->current_stock }}
                <a href="#" class="btn btn-default btn-rounded" data-toggle="modal" data-target="#modalContactForm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a></td>
