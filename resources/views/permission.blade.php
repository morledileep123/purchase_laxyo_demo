...
<div class="container-fluid">
  ...
  <h5 class="main-title-w3layouts mb-2">Permission Listing</h5>
            ...
            @if (!empty($permission))
              ...
              <tr>
                ...
                <td>
                  ...
                  <form id="delete-form-{{ $row->id }}" action="{{ route('permission.destroy', $row->id) }}" method="POST" style="display: none;">
                    @csrf
                    @method('DELETE')
