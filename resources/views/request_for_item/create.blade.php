  ...
  <div class="card">
    ...
    <div class="card-header"> 
      ...
      <div class="float-sm-right">
        <a href="{{ url('home') }}" class="btn btn-secondary btn-sm px-3">Back</a>
      </div>
    </div>
  {{--  Alert Message  --}}
    <div class="container">
  ...
  {{--  Alert Message  --}}
    ...
    <div class="card">
      <div class="card-body">
        ...
        <form action="{{ route('request_for_item.store') }}" method="post" enctype="multipart/form-data">
          @csrf
          <div class="row">
            <div class="col-md-8">
          ...
          <table id="invoice-item-table" class="table table-bordered">
            ...
            <tr>
              ...
              <td>
                <div class="row" >
                  <div class="col-md-12">
                  <input type="file" name="rfi_image[]" id="rfi_image1" class="imgupload" style="display:none">
                  <img src="{{asset('assets/img/images.png')}}" style="width: 35px;" class="OpenImgUpload">
                  </div>
                </div>
              </td>
...
$(document).ready(function(){
  ...
  $(document).on('click', '#add_row', function(){
    ...
    html_code += '<td><div class="row"><div class="col-md-12"><textarea name="description[]" id="description'+count+'" data-srno="'+count+'" class="form-control input-sm description description"></textarea></div></div></td>';

    html_code += '<td><div class="row"><div class="col-md-12"><input type="file" name="rfi_image[]" id="rfi_image'+count+'" data-srno="'+count+'" class="form-control imgupload" style="display:none"><img src="{{asset('assets/img/images.png')}}" style="width: 35px;" id="OpenImgUpload'+count+'"></div></div></td>';
    ...
    $('#OpenImgUpload'+count).click(function(){ $('#rfi_image'+count).trigger('click'); });
