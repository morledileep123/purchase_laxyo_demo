...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-10">
            <h3 class="main-title-w3layouts mb-2"  style="margin-left: 20px;">Manage Transactions</h3>
        </div>
        <div class="col-md-2">
            <button type="button" class="btn dropdown-toggle btn-success mb-3" data-toggle="dropdown">
                Create Document</button>
            <div class="dropdown-menu">
                <a class="dropdown-item border-bottom" href="{{url('/vendor_quotation')}}">Send Qutation To Vendor</a>
            </div>
            <a href="{{ url()->previous() }}" class="main-title-w3layouts mb-2 float-right" style="margin-right: 25px !important;"><i class="fa fa-arrow-left"></i>  Back</a>
        </div>
    </div>
