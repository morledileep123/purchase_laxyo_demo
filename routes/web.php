...
Route::get('item-location', 'ItemController@itemsite')->name('item-location');
...
Route::get('/fetchItems', 'HomeController@fetchItems')->name('fetchItems');
//Auth::routes();
// all
...
Route::post('/delete-multiple-category', 'PrchNotificationController@deleteMultiple');
...
Route::group(['middleware' => ['role:purchase_superadmin']], function(){
        ...
        Route::resource('rfi_information', 'RFIInformationController');
        Route::POST('vendor_excel_import', 'VendorController@vendorexcel')->name('vendor_excel_import');
        Route::get('vendorExcel', 'VendorController@downloadVenderSheetFormat')->name('vendorExcel');

        Route::post('teams_name_update', 'PurchaseTeamsController@teams_name_update');
        Route::post('remove_team_member_name', 'PurchaseTeamsController@remove_team_member_name');
        Route::post('NewSuperAdmin', 'PurchaseTeamsController@NewSuperAdmin');
        Route::post('NewAdmin', 'PurchaseTeamsController@NewAdmin');
        Route::post('NewAccountant', 'PurchaseTeamsController@NewAccountant');
        Route::post('NewManager', 'PurchaseTeamsController@NewManager');
        Route::post('NewUser', 'PurchaseTeamsController@NewUser');
...
Route::group(['middleware' => ['role:prch_accountant|purchase_superadmin|purchase_admin']],function(){
    Route::resource('/Enquiry', 'EnquiryController');
    Route::get('EnquiryShow/{id}', 'EnquiryController@show');
    Route::resource('/ItemsAndVendor', 'VendorsEnquiryController');

    Route::post('fetchVendor', 'VendorsEnquiryController@fetch_Vendor')->name('fetchVendor');
    Route::get('showVendorDetails/{id}', 'VendorsEnquiryController@show_Vendor_details');
    Route::post('fetchVendorName', 'VendorsEnquiryController@fetch_Vendor_Name')->name('fetchVendorName');
    // Route::post('send_vendor_id', 'EnquiryController@index')->name('send_vendor_id');
    Route::post('send_vendor_company','EnquiryController@index');

    Route::resource('vendoritems', 'VendorItemsController');
    Route::get('vendoritemsDemo', 'VendorItemsController@indexdemo');
    Route::post('/import', 'VendorItemsController@importData');
    Route::get('vendorItemsDescExcel', 'VendorItemsController@downloadVenderItemsDescSheetFormat')->name('vendorItemsDescExcel');
    Route::post('vendor_items_excel_import', 'VendorItemsController@vendorItemsdesImport')->name('vendor_items_excel_import');
});
...
Route::group(['middleware' => ['role:prch_accountant']], function () {
    ...
    Route::resource('payment', 'GRR_Payment_Controller');
    Route::get('payment/create/{id}', 'GRR_Payment_Controller@create');
});
...
Route::group(['middleware' => ['role:purchase_manager']], function () {
    ...
    Route::post('/update_delivery_date', 'RequestForItemManagerController@update_delivery_date')->name('update_delivery_date');
    Route::get('manager_view_hold_item/{id}', 'RequestForItemManagerController@manager_view_hold_item');
